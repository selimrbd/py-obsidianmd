...
from .templates import (add_test_function_to_global, t_build_metaobject,
                        t_exists, t_extract_str, t_remove_duplicate_values,
                        t_str_to_dict, t_to_string)
...
for n in ["n4"]:
    add_test_function_to_global(glob=globals(), fn=t_remove_duplicate_values, 
                                note_name=n, data=DATA, meta_type=META_TYPE)
